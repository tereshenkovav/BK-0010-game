...
START:	
	...
	JSR PC,	@#CLEAR_LINE
        ...
        BIT #100,@#177716; Проверка клавиатуры, есть ли нажатие
        BEQ     NO_KEY   ; Если нет, то пропуск обработки клавиш

	MOVB	@#177662,R0 ;код нажатой клавиши в регистр R0
	CMPB	R0,#10      ;нажата клавиша "курсор влево"?
        BNE     NEXT1
	DEC	R4          ; Сдвиг позиции линии
	 
NEXT1:	CMPB	R0,#31      ;нажата клавиша "курсор вправо"?
	BNE     NEXT2
