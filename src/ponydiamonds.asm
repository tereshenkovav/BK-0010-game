...
ARR_STARS: .WORD SPR_STAR_PLUS_GREEN,101,142,SPR_STAR_PLUS_RED,42,220
  .WORD SPR_STAR_CROSS_GREEN,126,221,SPR_STAR_PLUS_BLUE,311,104
  .WORD SPR_STAR_PLUS_RED,251,122,SPR_STAR_CROSS_GREEN,113,55
  .WORD SPR_STAR_PLUS_GREEN,332,157,SPR_STAR_CROSS_BLUE,145,50
  .WORD SPR_STAR_CROSS_GREEN,217,206,SPR_STAR_CROSS_RED,203,62
.include "strings.inc"
.EVEN
.END
